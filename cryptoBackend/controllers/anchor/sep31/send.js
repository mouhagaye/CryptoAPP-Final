...
const InitiateSendActionResponse = InitiateSendActionResponse

exports.initiateSendAction  (
...
export const setCustomerTypesAction = ("sep31Send/setCustomerTypesAction", ({ senderType, receiverType }) => {
  if (senderType) {
    log.instruction({
