...
@Component({
  selector: 'app-payement-marchand',
  templateUrl: './payement-marchand.page.html',
  styleUrls: ['./payement-marchand.page.scss'],
})
export class PayementMarchandPage implements OnInit {
